...
export default function Home() {
  ...
  return (
    <div className="bg-[#F6F3EC] text-[#1F2A24] font-sans overflow-x-hidden">
      {/* Header */}
      <header className={`fixed top-0 left-0 w-full flex items-center justify-between px-[6vw] py-7 z-100 ${scrolled ? 'bg-white/90 backdrop-blur-xl shadow-sm' : 'mix-blend-difference'}`}>
        ...
        <a href="#contato" className="text-white border border-white/40 px-5 py-2.5 text-xs rounded-sm hover:bg-white/10 transition">
          Agendar consulta
        </a>
      </header>

      {/* Hero */}
      <section className="relative h-screen min-h-[640px] flex flex-col justify-end px-[6vw] pb-16 overflow-hidden">
        <div 
        ...
        <div className="relative z-10 text-white max-w-[900px]">
          <p className="text-[#B08D3F] text-xs uppercase tracking-widest mb-6 flex items-center gap-2.5" data-reveal>
            <span className="w-6 h-px bg-[#B08D3F]" />
            Medicina veterinária de precisão
          </p>
          <h1 className="text-6xl md:text-8xl font-serif font-light mb-6" data-reveal>
            Cuidado que <em className="italic font-light text-[#B08D3F]">se sente</em>,<br />da consulta ao afeto.
          </h1>
          <p className="text-lg max-w-[480px] text-white/82 font-light leading-relaxed" data-reveal>
        ...
        <div className="absolute right-[6vw] bottom-10 text-white/65 text-xs uppercase tracking-wider flex items-center gap-2.5 writing-mode-vertical">
          Role para explorar
      ...
      {/* Philosophy */}
      <section id="filosofia" className="py-[150px] px-[6vw]">
        <div className="max-w-[1280px] mx-auto grid grid-cols-2 gap-[100px] items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-medium mb-7" data-reveal>
              Ciência veterinária,<br />conduzida com presença.
            </h2>
            <p className="text-lg text-[#1F2A24]/72 font-light leading-relaxed max-w-[520px] mb-5" data-reveal>
            ...
            <p className="text-lg text-[#1F2A24]/72 font-light leading-relaxed max-w-[520px]" data-reveal>
            ...
            <div className="flex gap-14 mt-13" data-reveal>
              <div>
                <b className="font-serif text-4xl block mb-1">18</b>
                <span className="text-xs uppercase tracking-wider text-[#7C8F7B]">Anos de atuação</span>
              </div>
              <div>
                <b className="font-serif text-4xl block mb-1">12</b>
                <span className="text-xs uppercase tracking-wider text-[#7C8F7B]">Especialidades</span>
              </div>
              <div>
                <b className="font-serif text-4xl block mb-1">24h</b>
      ...
      {/* Services */}
      <section id="servicos" className="bg-[#16241F] text-[#F6F3EC] py-[150px] px-[6vw]">
        <div className="max-w-[1280px] mx-auto">
          <p className="text-[#B08D3F] text-xs uppercase tracking-widest mb-6 flex items-center gap-2.5" data-reveal>
            <span className="w-6 h-px bg-[#B08D3F]" />
            O que tratamos
          </p>
          <h2 className="text-4xl md:text-5xl font-serif font-medium max-w-[640px] mb-18" data-reveal>
            Especialidades sob um único endereço, pensadas para cada fase da vida do seu animal.
          </h2>
          <div className="grid grid-cols-4 gap-px bg-[#F6F3EC]/14">
            {[
              ...
              <div key={service.num} className="bg-[#16241F] p-11 min-h-[320px] flex flex-col justify-between hover:bg-[#1C2D26] transition" data-reveal>
                <span className="text-[#B08D3F] text-xs font-mono">{service.num}</span>
                <div>
                  <h3 className="text-2xl font-serif font-normal mb-3.5">{service.title}</h3>
      ...
      <section className="py-[150px] px-[6vw]">
        <div className="max-w-[1280px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-serif font-medium mb-5" data-reveal>
            Nosso processo
          </h2>
          <p className="text-lg text-[#1F2A24]/72 font-light mb-20 max-w-[600px]" data-reveal>
          ...
          <div className="grid grid-cols-4 gap-10">
            {[
              ...
              <div key={step.num} className="border-t border-[#1F2A24]/14 pt-6">
                ...
                <h3 className="text-xl font-serif font-medium mb-2.5">{step.title}</h3>
      ...
      {/* Team */}
      <section id="equipe" className="py-[150px] px-[6vw]">
        <div className="max-w-[1280px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-serif font-medium mb-5" data-reveal>
            Nossa equipe
          </h2>
          ...
          <div className="grid grid-cols-3 gap-11">
            <div data-reveal>
              ...
              <h3 className="text-2xl font-serif font-medium">Equipe Multidisciplinar</h3>
      ...
      {/* Testimonials */}
      <section className="bg-[#EFEAE0] py-[150px] px-[6vw]">
        <div className="max-w-[1280px] mx-auto">
          <div className="overflow-hidden">
            {quotes.map((quote, idx) => (
              <div key={idx} className={`transition-opacity duration-500 ${activeQuote === idx ? 'opacity-100' : 'opacity-0 absolute'}`}>
                <blockquote className="text-3xl md:text-4xl font-serif italic font-normal leading-relaxed max-w-[900px] mb-8">
                  "{quote.text}"
                </blockquote>
          ...
          <div className="flex gap-2.5 mt-13">
            {quotes.map((_, idx) => (
              <button
                key={idx}
      ...
      {/* Gallery */}
      <section className="py-0 px-[6vw]">
        <div className="grid grid-cols-3 gap-px bg-[#1F2A24]/14">
          {[
            ...
            <div key={idx} className="aspect-[1/1.15] overflow-hidden" data-reveal="scale">
              <img 
                src={src}
                alt={`Galeria ${idx + 1}`}
      ...
      {/* Contact */}
      <section id="contato" className="bg-[#16241F] text-[#F6F3EC] py-[150px] px-[6vw]">
        <div className="max-w-[1280px] mx-auto grid grid-cols-2 gap-[100px]">
          <div>
            <p className="text-[#B08D3F] text-xs uppercase tracking-widest mb-6 flex items-center gap-2.5" data-reveal>
              <span className="w-6 h-px bg-[#B08D3F]" />
              Entre em contato
            </p>
            <h2 className="text-4xl md:text-5xl font-serif font-medium mb-8" data-reveal>
              Agende sua consulta
            </h2>
          ...
          <form className="flex flex-col gap-5.5">
            <input 
              ...
              className="bg-transparent border-b border-[#F6F3EC]/28 py-3.5 px-0.5 text-base text-white placeholder-[#F6F3EC]/40 outline-none focus:border-[#B08D3F] transition"
            />
            <input 
              type="email" 
            ...
            <textarea 
              ...
              rows={4}
              className="bg-transparent border-b border-[#F6F3EC]/28 py-3.5 px-0.5 text-base text-white placeholder-[#F6F3EC]/40 outline-none focus:border-[#B08D3F] transition resize-none"
            />
            <button className="bg-[#B08D3F] text-[#0E1713] mt-3.5 px-8 py-4 font-mono text-xs uppercase tracking-widest rounded-sm hover:bg-[#c9a558] transition transform hover:-translate-y-0.5">
              Enviar
            </button>
          </form>
        </div>
